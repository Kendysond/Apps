    ...
    <div class="container ">
        ...
        <div class="booking-form-wrap padding">
            <h3 class="entry-title">Details</h3><hr />
             ...
             <form class="tt-form booking-form margin-top padding-top" data-parsley-validate="" action="contact_form_send_message" method="POST" novalidate="">
                ...
                <div class="row form-row"><!-- Start Row -->
                        <div class="col-md-7 column"><!-- Start Column -->
                            <div class="input-cover contact-line">
                                <input type="text" class="contact-form-line" value="" placeholder="Full Name" name="fullname" >
                            </div>
                        </div>
                        <div class="col-md-5 column"><!-- Start Column -->
                            <div class="input-cover contact-line">
                                <input type="text" class="contact-form-line" value="" placeholder="E-Mail" name="email" >
                            </div>
                        </div>
                </div><!-- End Row -->
                <div class="row form-row"><!-- Start Row -->
